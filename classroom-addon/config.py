...
class Config(object):
    ...
    GOOGLE_CLIENT_ID = (
        ...
        or "118866449054-b5i7of5l0191oqd2pumvg63j7bopcop0.apps.googleusercontent.com"
    )
    GOOGLE_CLIENT_SECRET = (
        os.environ.get("GOOGLE_CLIENT_SECRET") or "YOUR_CLIENT_SECRET_HERE"
    )
    ...
    CLOUDFLARE_WORKER_URL = (
        ...
        or "https://classroom-auto-grader.brian-mabry-edwards.workers.dev"
    )
