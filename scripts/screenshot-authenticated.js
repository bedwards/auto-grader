...
class AuthenticatedScreenshotTester {
  ...
  async authenticateAndTest() {
    ...
    console.log('   - Google Client ID: 118866449054-b5i7of5l0191oqd2pumvg63j7bopcop0.apps.googleusercontent.com');
    console.log('   - Gemini API Key: AIzaSyA8cY_GiNH4PZm_ozSM-028paL8wwpRvLg');
    console.log('   - Cloudflare Worker: https://classroom-auto-grader.brian-mabry-edwards.workers.dev');
