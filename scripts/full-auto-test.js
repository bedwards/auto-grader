...
const TEST_CREDENTIALS = {
  googleClientId: process.env.GOOGLE_CLIENT_ID || 'your-client-id.apps.googleusercontent.com',
  geminiApiKey: process.env.GEMINI_API_KEY || 'your-api-key-here',
  cloudflareWorkerUrl: process.env.CLOUDFLARE_WORKER_URL || 'https://your-worker.workers.dev'
};
